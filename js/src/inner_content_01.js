...
*/
 ...
 var link = ['http://naver.com', 'http://daum.net', 'http://google.com', 'http://behance.net', 'http://pinterest.com', 'http://dribble.com'];

var productList = [
{color:'#ff0', text:'제품_1 에 대한 각각 설명하기!!!', link:'http://naver.com'},
{color:'#cca', text:'제품_2 에 대한 각각 설명하기!!!', link:'http://daum.net'},
{color:'#acf', text:'제품_3 에 대한 각각 설명하기!!!', link:'http://google.com'},
{color:'#f06', text:'제품_4 에 대한 각각 설명하기!!!', link:'http://behance.net'},
{color:'#f7f', text:'제품_5 에 대한 각각 설명하기!!!', link:'http://pinterest.com'},
{color:'#afa', text:'제품_6 에 대한 각각 설명하기!!!', link:'http://dribble.com'}
];
